...
const CONFIG = {
    ...
    loveLetter:
        '亲爱的，两周年快乐。\n\n' +
        '还记得两年前的 4 月 28 号吗？实验课上，我们第一次加了微信。那时候还不知道，这个微信号的主人会成为我生命里最重要的人。\n\n' +
        ...
        '我还有好多地方想和你一起去——稻城的星空、圣托里尼的日落、北海道的雪。只要是你，去哪里都好。\n\n' +
        '我爱你，不只在纪念日，是每一天。\n\n' +
        '两周年快乐，我的小可爱。',
    ...
    // 未来想去的地方
    placesWish: [
        { name: '稻城亚丁', desc: '想和你一起看那片蓝得不像话的天空', emoji: '🏔️' },
        { name: '圣托里尼', desc: '蓝白房子与爱琴海的日落，一定很适合我们说"我爱你"', emoji: '🇬🇷' },
        { name: '北海道', desc: '冬天去看雪，在雪地里画一颗心，泡着温泉看雪花飘落', emoji: '♨️' },
        { name: '新疆', desc: '喀纳斯的秋天、禾木的晨雾、赛里木湖的蓝。中国最美的风景，想和你一起见证', emoji: '🏕️' },
        { name: '冰岛', desc: '一起追极光，在黑沙滩上牵手，见证地球最魔幻的一面', emoji: '🌌' },
        { name: '川西', desc: '四姑娘山、色达、理塘……一路向西，每一帧都是大片', emoji: '🏔️' },
    ],
